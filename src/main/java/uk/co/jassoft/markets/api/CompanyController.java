...
import uk.co.jassoft.markets.repository.UserRepositoryCustom;
...
public class CompanyController extends BaseController
{
    ...
    public @ResponseBody uk.co.jassoft.markets.datamodel.Page<Company> getCompanysByExchangePageable(final HttpServletResponse response, @PathVariable String id, @PathVariable int offset, @PathVariable int length) throws UnknownHostException
    {
        ...
        response.setHeader("Cache-Control", "max-age=" + CacheTimeout.SIX_HOURS);
        return new uk.co.jassoft.markets.datamodel.Page<>((int) companies.getTotalElements(), companiesToReturn);
    }

    @PreAuthorize("permitAll")
    @RequestMapping(value = "exchange/{id}/search/{searchTerm}/offset/{offset}/length/{length}", method = RequestMethod.GET)
    public @ResponseBody uk.co.jassoft.markets.datamodel.Page<Company> searchCompanysByExchangePageable(final HttpServletResponse response, @PathVariable String id, @PathVariable String searchTerm, @PathVariable int offset, @PathVariable int length) throws UnknownHostException
    {
