...
import uk.co.jassoft.markets.api.auth.ApiAuthenticationToken;
import uk.co.jassoft.markets.api.auth.RestAuthenticationEntryPoint;
import uk.co.jassoft.markets.api.auth.TokenAuthenticationManager;
...
@Configuration
@ComponentScan("uk.co.jassoft.markets.api")
